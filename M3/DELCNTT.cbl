      ...
      *>          "D:\Estudos_COBOL\CONTATOS.DAT"
       ...
       P300-EXCLUIR.
           ...
           OPEN I-O CONTATOS
              ...
              IF FS-OK THEN
                  DISPLAY "INFORME O CODIGO DO CONTATO PARA DELETAR"
                  ACCEPT ID-CONTATO
                   READ CONTATOS INTO WS-REGISTRO
                       ...
                       NOT INVALID KEY
                           ...
                           DELETE CONTATOS RECORD *> DELETA O REGISTRO
                           DISPLAY "CONTATO EXLUIDO COM SUCESSO!"
                       ELSE
                           DISPLAY "EXCLUSÃO NÃO REALIZADA"
                       END-IF
                   END-READ
               ELSE
